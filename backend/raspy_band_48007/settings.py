"""
Django settings for raspy_band_48007 project.
...
ROOT_URLCONF = 'raspy_band_48007.urls'
...
WSGI_APPLICATION = 'raspy_band_48007.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "raspy_band_48007 API",
    "DESCRIPTION": "API documentation for raspy_band_48007 App",
    "VERSION": "v1",
}
